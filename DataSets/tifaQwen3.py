...
from Qwen3Call import Qwen3Call, load_Qwen3
...
if __name__ == "__main__":
    # 替换为你的JSON文件路径
    json_path = "/home/sxm/flux-workspace/Qwen-Image-Lightning/tifa/tifa_v1.0/tifa_v1.0_text_inputs.json"
    ...
    for i, prompt in enumerate(prompts):
        ...
        try:
            o_names, o_boxes = Qwen3Call(text, tokenizer, model)
    ...
    # ✅ 修改：保存为 pickle 文件
    output_path = "/home/sxm/flux-workspace/Qwen-Image-Lightning/DataSets/XU_Bench/Tifa_Bench/tifaData.p"
